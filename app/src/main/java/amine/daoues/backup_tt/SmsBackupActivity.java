...
//import amine.daoues.backup_tt.FetchSMS;
//import amine.daoues.backup_tt.constants.AppConstants;
...
public class SmsBackupActivity extends Activity
{
  ...
  public void initAllViews()
  {
	...
	this.btnSendToEmail = ((Button)findViewById(R.id.btnSendToEmail));
      this.btnListSMS = ((Button)findViewById(R.id.btnListAllMessages));
...
//    tvLastBackup.setTypeface(localTypeface);
      btnListSMS.setOnClickListener(new View.OnClickListener() {
          @Override
          public void onClick(View v) {
              Intent intent = new Intent(SmsBackupActivity.this, FetchSMS.class);
