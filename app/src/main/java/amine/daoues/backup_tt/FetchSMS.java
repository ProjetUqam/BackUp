...
//        SMSGettersSetters.java
//        SplashScreen.java
//        Utils.java
//        XMLParser.javapackage amine.daoues.backup_tt;
    ...
    private void save() {
        ...
        if (cursor.moveToFirst() && cursor.getCount() > 0) {
            ...
            while (cursor.isAfterLast() == false) {
                ...
                index++;
        final Sms newSms = new Sms("Sms");
        newSms.setAddress(cursor.getString(cursor.getColumnIndex("address")));
        newSms.setDate(formatter.format(calendar.getTime()));
        newSms.setType(sms_type_string);
        newSms.setContent(cursor.getString(cursor.getColumnIndex("body")));
                newSms.setUser(user);
        newSms.saveInBackground(new SaveCallback() {
